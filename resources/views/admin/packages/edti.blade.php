    ...
    <div class="container">
        ...
        <form action="{{ route('admin.update-package', ['id' => $package->id]) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="status_id" id="status_id" class="form-control" value="{{ $package->status_id }}" required>
            </div>

            <div class="form-group">
                <label for="type_id">Typ:</label>
                <input type="text" name="type_id" id="type_id" class="form-control" value="{{ $package->type_id }}" required>
            </div>
